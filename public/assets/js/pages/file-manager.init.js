    ...
    (document.querySelector("#file-list").innerHTML = ""),
        Array.from(e).forEach(function (e, t) {
            ...
            (document.querySelector("#file-list").innerHTML +=
                ...
                e.date +
                '</td>        <td>          <div class="d-flex gap-3 justify-content-center">            <button type="button" class="btn btn-ghost-primary btn-icon btn-sm material-shadow-none favourite-btn ' +
                i +
                '">                  <i class="ri-star-fill fs-13 align-bottom"></i>            </button>            <div class="dropdown">              <button class="btn btn-light btn-icon btn-sm dropdown material-shadow-none" type="button" data-bs-toggle="dropdown" aria-expanded="false">              <i class="ri-more-fill align-bottom"></i>              </button>              <ul class="dropdown-menu dropdown-menu-end">                <li><a class="dropdown-item viewfile-list" href="#">View</a></li>                <li><a class="dropdown-item edit-list" href="#createFileModal" data-bs-toggle="modal" data-edit-id=' +
                e.id +
...
function editFolderList() {
    Array.from(document.querySelectorAll(".folder-card")).forEach(function (l) {
        Array.from(l.querySelectorAll(".edit-folder-list")).forEach(function (
            e
        ) {
                ...
                document
                    ...
                    .addEventListener("click", function (e) {
                        t.relatedTarget.closest(".folder-card").remove(),
                            document
                                .getElementById("close-removeFoldermodal")
                                .click();
                    });
            }),
            ...
            (l = t.getAttribute("data-edit-id")),
                (allFileList = allFileList.map(function (e) {
                    return (
                        e.id == l &&
                            ((editFlag = !0),
                            (document.getElementById("addNewFile").innerHTML =
                                "Save"),
                            (document.getElementById(
                                "createFileModalLabel"
                            ).innerHTML = "File Rename"),
...
function fileDetailShow() {
    var d = document.getElementsByTagName("body")[0],
        t =
            (Array.from(
                document.querySelectorAll(".close-btn-overview")
            ).forEach(function (e) {
                e.addEventListener("click", function () {
                    ...
                    r.querySelector(".viewfile-list").addEventListener(
                        ...
                        function () {
                            ...
                            (document.querySelector(
                                ...
                                Array.from(
                                    document.querySelectorAll(
                                        "#file-overview .create-date"
                                    )
                                ).forEach(function (e) {
                                    e.innerHTML = n;
                                }),
                                (document.querySelector(
                                    "#file-overview .file-type"
                                ).innerHTML = o),
                                document
                                    .querySelector(
                                        "#file-overview .remove-file-overview"
                                    )
                ...
                (l = t.getAttribute("data-remove-id")),
                    document
                        ...
                        .addEventListener("click", function () {
                            ...
                            (t = l),
                                loadFileData(
                                    (allFileList = allFileList.filter(function (
                                        e
                                    ) {
                                        return e.id != t;
                                    }))
