        ...
        (barchartCountriesColors &&
            ((options = {
                series: [
                    {
                        data: [
                            1010, 1640, 490, 1255, 1050, 689, 800, 420, 1085,
                            589,
                        ],
                        name: "Sessions",
                    },
...
areachartbitcoinColors &&
    ...
    (areachartbitcoinColors = getChartColorsArray(
        "results_sparkline_charts2"
    )) &&
        ((options = {
...
Array.from(document.querySelectorAll("#candidate-list li")).forEach(function (
    ...
    document.getElementById("back-btn").addEventListener("click", function () {
        (document.getElementById("notification-overlay").style.visibility =
            "hidden"),
            (document.getElementById("notification-overlay").style.opacity =
                "0");
    });
