                                    ...
                                    <div class="col-md-6">
                                        ...
                                        @if ($review->orderItem)
                                            <p><strong>Định dạng:</strong>
                                                <span class="badge {{ strtolower($review->orderItem->format) === 'ebook' ? 'bg-info' : 'bg-primary' }}">
                        ...
                        <div class="card-body row">
                            <div class="col-md-6">
                                ...
                                <form action="{{ route('admin.reviews.update-status', $review->id) }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('PATCH')
                                    <button type="submit" class="btn btn-sm {{ $review->status === 'hidden' ? 'btn-success' : 'btn-warning' }}">
