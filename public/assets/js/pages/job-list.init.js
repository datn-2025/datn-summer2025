...
function jobDetailShow() {
    Array.from(document.querySelectorAll("#job-list .joblist-card")).forEach(
        function (s) {
            s.querySelector(".viewjob-list").addEventListener(
                "click",
                function () {
                    ...
                    (document.querySelector("#cover-img").src = e),
                        (document.querySelector(
                            "#job-overview .view-companylogo"
                        ).src = t),
                        (document.querySelector(
                            "#job-overview .view-title"
                        ).innerHTML = n),
                        (document.querySelector(
                            "#job-overview .view-companyname"
                        ).innerHTML = o),
                        (document.querySelector(
                            "#job-overview .view-location"
                        ).innerHTML = r),
                        (document.querySelector(
                            "#job-overview .view-desc"
                        ).innerHTML = a),
                        (document.querySelector(
                            "#job-overview .view-type"
                        ).innerHTML = i),
                        (document.querySelector(
                            "#job-overview .view-postdate"
                        ).innerHTML = l),
                        (document.querySelector(
                            "#job-overview .view-experience"
                        ).innerHTML = c);
                }
            );
        }
