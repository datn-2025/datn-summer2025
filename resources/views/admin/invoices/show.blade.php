                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap">
                    <div>
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <span
                                class="badge badge-{{ $invoice->order->payment_status == 'paid' ? 'success' : 'warning' }} ml-3">
                        ...
                        <div class="text-muted">
                            ...
                            <span><i
                                    class="far fa-calendar-alt mr-1"></i>{{ $invoice->created_at->format('d/m/Y H:i') }}</span>
                        </div>
                    </div>
                    <div class="mt-3 mt-sm-0">
                        ...
                        <a href="{{ route('admin.invoices.index') }}" class="btn btn-secondary btn-icon-split ml-2">
                            ...
                            <div class="col-md-6">
                                <div class="order-summary p-3 bg-light rounded">
                                    ...
                                    <div class="summary-item d-flex justify-content-between">
                                        ...
                                        <span
                                            class="text-primary h5 mb-0">{{ number_format($invoice->total_amount) }}đ</span>
                                    </div>
                                </div>
                            </div>
