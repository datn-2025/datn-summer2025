                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            @if ($review->admin_response)
                                ...
                                <div class="form-control-sm bg-light p-2 rounded">
                            ...
                            @else
                                ...
                                <form action="{{ route('admin.reviews.response.store', $review) }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="admin_response" id="admin_response" class="form-control" rows="4" required placeholder="Nhập nội dung phản hồi..."></textarea>
                                    </div>
