                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('category') is-invalid @enderror" 
                                        ...
                                        <option value="Sách" {{ old('category') == 'Sách' ? 'selected' : '' }}>Sách</option>
                                        <option value="Kinh doanh" {{ old('category') == 'Kinh doanh' ? 'selected' : '' }}>Kinh doanh</option>
                                        <option value="Sức khỏe" {{ old('category') == 'Sức khỏe' ? 'selected' : '' }}>Sức khỏe</option>
                                    </select>
                                    @error('category')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="mt-2">
                                        <img id="thumbnail-preview" src="" alt="" style="max-width: 100%; display: none;">
                                    </div>
                                    @error('thumbnail')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
