...
!(function () {
    ...
    const ut = (e, t, o) => {
        ...
        Wt = (e, t) => Lt(e, t, 1),
        Mt = (e) =>
            ue("col")(e) ? Lt(e, "span", 1) > 1 : Wt(e, "colspan") > 1,
    ...
    let ko = Xt(() =>
        ((e, t, o) => {
            ...
            C.from(window.navigator.userAgentData),
            Oo
        )
    );
    const Eo = () => ko(),
        ...
        lr = (e, t) => () =>
            st(e) ? t(e) : parseFloat(zt(e, "width").getOr("0")),
        ar = (e) => {
    ...
    const ws = (e, t, o, n) => {
        ...
        Bs = (e, t, o) =>
            t.length <= 1
                ? C.none()
                : ks(e, o.firstSelectedSelector, o.lastSelectedSelector).map(
                      (e) => ({ bounds: e, cells: t })
                  ),
        ...
        Hs = (e, t) => {
            e.on("BeforeGetContent", (t) => {
                ...
                if (!0 === t.selection) {
                    const t = ((e) =>
                        _(Fs(e), (e) => Ce(e, Ws.selectedSelector)))(e);
                    t.length >= 1 && o(t);
                }
            }),
                ...
                s = (e) =>
                    j(e, (e) =>
                        E(
                            e.cells,
                            (e) => (
                                wl(e.element, "span", e.colspan, 1), e.element
                            )
                        )
                    ),
                l = (t, o) => {
        ...
        $l = (e, t, o) =>
            _(o, (o) => o >= e.column && o <= Ho(t[0]) + e.column),
        Vl = (e, t, o, n, r) => {
            ((e, t, o, n) => {
                t > 0 &&
                    t < e[0].cells.length &&
                    N(e, (e) => {
                        ...
                        for (
                            ...
                            jo(e, t + s, et(l, !0, e.cells[t + s].isLocked)),
                                s++;
                    });
            })(t, e, r, n.cell);
            const s = Ml(o, t),
        ...
        Kl = (e, t, o, n) =>
            ((e, t, o, n) =>
                void 0 !== Fo(e[t], o) &&
                t > 0 &&
                n(Fo(e[t - 1], o), Fo(e[t], o)))(e, t, o, n) ||
            ((e, t, o) => t > 0 && o(Fo(e, t - 1), Fo(e, t)))(e[t], o, n),
        Yl = (e, t, o, n) => {
            const r = (e) =>
                ((e) =>
                    "row" === e ? ((e) => Wt(e, "rowspan") > 1)(t) : Mt(t))(e)
                    ? `${e}group`
                    : e;
            return e
                ? rl(t)
        ...
        ua = (e, t = ma) => {
            const o = (o) => {
                if (ia(o))
                    return ca((r = { element: o }).element)
                        ? e.colgroup(r)
                        : e.row(r);
                {
                    const r = o,
                        s = ((t) => (aa(t.element) ? e.col(t) : e.cell(t)))(
                            t(r)
                        );
        ...
        Wa = (e) => (t, o) =>
            kl(t, o).filter((o) => !(e ? _a : za)(t, o.cells)),
        Ma = fa("th"),
        ja = fa("td"),
        Pa = Ol(
            (e, t, o, n) => {
        ...
        $a = Ol(
            ...
            (e, t) =>
                Nl(e, t).map((t) => ({ details: t, pixelDelta: -Aa(e, t) })),
            Ba,
            xa,
            ua
        ),
        ...
        Xa = Ol(
            ...
            (e, t) =>
                ((e, t) => t.mergable)(0, t).filter((t) => Bl(e, t.cells)),
            Na,
            f,
            ga
        ),
        ...
        Cc = (e, t) =>
            0 === e.length
                ? t
                : z(e, (e, t) => yc.from(t).fold(g(0), h, h) + e, 0),
        Tc = (e, t) =>
            yc.from(e).fold(
                g(e),
                (e) => e + t + "px",
                ...
                i = () =>
                    l((t, o) =>
                        ((e, t, o) => {
                            ...
                            t,
                            Ms(Fs(e), t, o),
                            Nr(f, xe.fromDom(e.getDoc()), C.none())
                        )
                    ),
                m = () =>
                    l((t, o) =>
                ...
                ((e, t, o) =>
                    e.caretPositionFromPoint
                        ? ((e, t, o) => {
                              var n;
                              return C.from(
                                  null === (n = e.caretPositionFromPoint) ||
                                      void 0 === n
                                      ? void 0
                                      : n.call(e, t, o)
                              ).bind((t) => {
