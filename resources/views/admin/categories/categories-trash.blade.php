...
<div class="container-fluid">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <!-- Tìm kiếm -->
            <form method="GET" action="{{ route('admin.categories.trash') }}" class="d-flex justify-content-end gap-2 mb-3">
            ...
            @if ($deletedCategories->isEmpty())
                <div class="text-center py-5">
                    @if (request()->filled('search_name_category'))
                        ...
                        <p class="text-muted">Không có danh mục nào khớp với <strong>"{{ request('search_name_category') }}"</strong>.</p>
                    @else
                        <lord-icon src="https://cdn.lordicon.com/jmkrnisz.json" trigger="loop" style="width:90px;height:90px"></lord-icon>
